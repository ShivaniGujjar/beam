...
const SUPABASE_PROJECT_ID = "raxeapbmgaokvvivfymi";
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      <AnimatePresence>
        {history && history.map((item) => {
          // 💡 OPTION 1 FIX: Direct Supabase CDN link generation per card
          const liveUrl = `https://${SUPABASE_PROJECT_ID}.supabase.co/storage/v1/object/public/deployments/outputs/${item.slug}/index.html`;
